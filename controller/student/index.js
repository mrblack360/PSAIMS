...
exports.addStudent =  (req, res) => {
  ...
  try {
    dbConnection.query("INSERT INTO student (firstName, middleName, lastName, gender, class) VALUES (?, ?, ?, ?, ?)",
    [firstName, middleName, lastName, gender, req.body.class],
      (err, results, fields) => {
...
exports.updateStudent = (req, res) => {
  ...
  try {
    dbConnection.query("UPDATE student SET firstName=?, middleName=?, lastName=?, gender=?, class=? WHERE id=?",
